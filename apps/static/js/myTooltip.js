...
(function (factory) {
    ...
    var methods = {
        ...
        create: function (data) {
            ...
            var tooltip = $('<div style="display: none; z-index: 1;" data-mytooltip-id="' + id + '" class="mytooltip system-mytooltip--' +
            ...
            if (options.hoverTooltip) {
                tooltip.append('<div class="mytooltip-backing ' + tooltipClasses.backing + '" style="z-index: 1;">');
            }
