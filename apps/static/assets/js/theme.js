...
var bandwidthSavedInit = function bandwidthSavedInit(percent) {
...
var totalSalesInit = function totalSalesInit(tag_name, select_month, months_data, monthsnumber_data) {
  var ECHART_LINE_TOTAL_SALES = tag_name;
  var SELECT_MONTH = select_month;
  var $echartsLineTotalSales = document.querySelector(ECHART_LINE_TOTAL_SALES);
  var months = months_data;
  // console.log(ECHART_LINE_TOTAL_SALES, SELECT_MONTH, months[0])
  function getFormatter(params) {
    ...
    // console.log(value);
    // 요기 표시되는 것이 그래프의 라벨
    // return "".concat(months[2], " ").concat(date.getDate(), ", ").concat(value);
    return "".concat(value);
  }
  ...
  if ($echartsLineTotalSales) {
    ...
    var userOptions = utils.getData($echartsLineTotalSales, 'options');
    var chart = window.echarts.init($echartsLineTotalSales);
    var monthsnumber = monthsnumber_data;
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        xAxis: {
          type: 'category',
          data: ['2023-01-05', '2023-02-06', '2023-03-07', '2023-04-08', '2023-05-09', '2023-06-10', '2023-07-11', '2023-08-12', '2023-09-13', '2023-10-14', '2023-11-15', '2023-12-16'],
          boundaryGap: false,
          axisPointer: {
            lineStyle: {
              color: utils.getGrays()['300'],
